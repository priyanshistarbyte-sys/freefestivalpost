            ...
            <form action="{{ route('sub-category.store') }}" enctype="multipart/form-data" method="POST">
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="mb-3 col-md-12 form-group" id="parent_category_box" style="display:none;">
                    ...
                    <div class="col-md-4">
                        <div class="mb-3 form-group">
                            ...
                            <textarea rows="5" name="noti_quote" id="noti_quote" placeholder="Enter Notification Quote"
