        ...
        <div class="card-body">
            ...
            <form action="{{ route('sub-category.update', $subCategory->id) }}" enctype="multipart/form-data" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="mb-3 col-md-3 form-group" id="parent_category_box"
                        style="{{ $subCategory->is_parent ? '' : 'display:none;' }}">
                ...
                <div class="row">
                    ...
                    <div class="mb-3  col-md-4 form-group">
                        ...
                        <div class="file-input-wrapper">
                            ...
                            <input type="file" name="noti_banner" id="noti_banner" class="file-input" accept="image/*"
                                onchange="previewImage(this, 'noti-banner-preview')">
                    ...
                    <div class="mb-3 col-md-4 form-group">
                        ...
                        <textarea rows="4" name="noti_quote" class="form-control">{{ $subCategory->noti_quote }}</textarea>
                    </div>
                </div>
                <div class="row">
                    <div class="mb-3 col-md-3 form-group">
