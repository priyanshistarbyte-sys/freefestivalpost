<form action="{{ route('videogif.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
    <div class="modal-body">
        <div class="row">
            <div class="mb-3 col-md-12 form-group">
                ...
                <select class="form-select" name="sub_category_id" id="sub_category_id" required>
                    ...
                    @foreach ($subcategories ?? [] as $subcategory)
                        <option value="{{ $subcategory->id }}">{{ $subcategory->mtitle }}</option>
                    @endforeach
                </select>
            </div>
            <div class="mb-3 col-md-6 form-group">
                ...
                <div class="radio-group">
                    <label class="radio-container">Free
                        <input type="radio" name="free_paid" value="0">
                        <span class="radio-checkmark"></span>
                    </label>
                    <label class="radio-container">Paid
                        <input type="radio" name="free_paid" value="1" checked>
                        <span class="radio-checkmark"></span>
                    </label>
                </div>
            </div>
            ...
            <div class="mb-3 col-md-6 form-group">
                ...
                <input type="text" placeholder="Enter Lable" class="form-control" name="lable" required>
            </div>
            <div class="mb-3 col-md-6 form-group">
                <label for="lablebg" class="form-label">Lable BG :</label>
                <input type="text" placeholder="Enter Lable BG" class="form-control" name="lablebg" required>
            </div>
